...
\begin{figure*}[!t]
	\centering
	\vspace{-1.5ex}
	\includegraphics[width=0.96\textwidth]{figures/AERoS-Process.pdf}%AMLAS-STAGE-3-V4.png
	\vspace{-3ex}
...
\begin{figure}[!t]
	\centering
	\includegraphics[width=0.55\textwidth]{figures/AERoS-Stage4-V3.pdf}%AERoS-Stage4.pdf %[width=0.55\textwidth]{figures/AERoS-Stage4.pdf}
	\vspace{-2ex}
...
While the focus of AERoS is to ensure the safety assurance of EB in swarms, the trustworthiness of an AS can be dependent on many factors other than safety, such as ethics and regulation, which we will investigate as part of future work.%the trustworthiness of an AS can be dependent on many other factors, such as ethics, and governance and regulation, which we will investigate as part of future work.
