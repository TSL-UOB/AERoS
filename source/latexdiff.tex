...
%DIF DEL SH.tex      Mon Feb  6 07:26:51 2023
%DIF ADD AERoS.tex   Mon Feb  6 07:19:17 2023
...
\author{Dhaminda B. Abeywickrama\inst{\dag}\inst{1}\orcidID{0000-0002-4423-0284} \and
	...
	Suet Lee\inst{1}\DIFdelbegin %DIFDELCMD < \orcidID{2222--3333-4444-5555} %%%
\DIFdelend \DIFaddbegin \orcidID{?} \DIFaddend \and
	Greg Chance\inst{1}\DIFdelbegin %DIFDELCMD < \orcidID{2222--3333-4444-5555} %%%
\DIFdelend \DIFaddbegin \orcidID{0000-0001-5334-370X} \DIFaddend \and
	\DIFdelbegin \DIFdel{Pete }\DIFdelend \DIFaddbegin \DIFadd{Peter D. }\DIFaddend Winter\inst{1}\DIFdelbegin %DIFDELCMD < \orcidID{2222--3333-4444-5555} %%%
\DIFdelend \DIFaddbegin \orcidID{0000-0003-0766-6297} \DIFaddend \and
	Arianna Manzini\inst{1}\DIFdelbegin %DIFDELCMD < \orcidID{2222--3333-4444-5555} %%%
\DIFdelend \DIFaddbegin \orcidID{0000-0001-7710-8974} \DIFaddend \and
	\DIFdelbegin \DIFdel{7th Author}\DIFdelend \DIFaddbegin \DIFadd{Shane Windsor}\DIFaddend \inst{1}\DIFdelbegin %DIFDELCMD < \orcidID{2222--3333-4444-5555} %%%
\DIFdelend \DIFaddbegin \orcidID{0000-0002-7597-4497} \DIFaddend \and
	\DIFdelbegin \DIFdel{8th Author}\DIFdelend \DIFaddbegin \DIFadd{Sabine Hauert}\DIFaddend \inst{1}\DIFdelbegin %DIFDELCMD < \orcidID{2222--3333-4444-5555} %%%
\DIFdelend \DIFaddbegin \orcidID{0000-0003-0341-7306} \DIFaddend \and
	\DIFdelbegin \DIFdel{9th Author}\DIFdelend \DIFaddbegin \DIFadd{Kerstin Eder}\DIFaddend \inst{1}\DIFdelbegin %DIFDELCMD < \orcidID{2222--3333-4444-5555}%%%
\DIFdelend \DIFaddbegin \orcidID{0000-0001-9746-1409}\DIFaddend \thanks{\dag D. B. Abeywickrama and J. Wilson contributed equally.}}
%
...
%
\begin{abstract} 
The overall behaviours of a swarm are not explicitly engineered in the system\DIFdelbegin \DIFdel{, but }\DIFdelend \DIFaddbegin \DIFadd{. However, }\DIFaddend they are an emergent consequence of the interaction of individual agents with each other and their environment. 
This emergent functionality poses a challenge to ensure their \emph{assurance}, such as safety. 
The main contribution of this paper is a process for the safety assurance of the emergent behaviour for use in autonomous robotic swarms called \emph{AERoS}, following the AMLAS guidance for machine \DIFdelbegin \DIFdel{learning-based }\DIFdelend \DIFaddbegin \DIFadd{learning }\DIFaddend systems. 
We explore our proposed guidance using \DIFdelbegin \DIFdel{illustrative examples taken from a public cloakroom case study.
}\DIFdelend \DIFaddbegin \DIFadd{an illustrative case study centred on a robot swarm operating a public cloakroom.
%DIF > We explore our proposed guidance using illustrative examples taken from a public cloakroom case study.
	}\DIFaddend 
...
Stage 1 contains two activities which are performed to define the safety assurance scope for the swarm (see Fig.~\ref{amlas-a-stage1}). In a swarm, individual robots execute simple behaviours, and \DIFdelbegin \DIFdel{these simple behaviours }\DIFdelend when performed by a large number of agents\DIFaddbegin \DIFadd{, these simple behaviours }\DIFaddend build to form EB.
%DIF > these simple behaviours when performed by a large number of agents build to form EB.  
%\vspace{-2ex}
...
\begin{table}[!t]
	...
	\begin{tabular}{p{5mm} p{116mm} }
		...
		*Assumption: Agents are considered stationary once they have not moved for $>$ \textbf{10 seconds}.
		...
		\hline
		2.5 & The swarm \emph{shall} experience $<$ \textbf{10\%} increase in \textbf{number of stationary agents} at any given time \DIFaddbeginFL \DIFaddFL{with }\DIFaddendFL \textbf{10\% injection} of \textbf{full communication fault} to the swarm.\\
		\hline
		2.6 & The swarm agents \emph{shall} experience $<$ \DIFdelbeginFL \DIFdelFL{10\% increase in }\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{10\%}} \DIFaddFL{increase in }\DIFaddendFL \textbf{stationary time\DIFdelbeginFL \DIFdelFL{10\% injection}\DIFdelendFL } \DIFaddbeginFL \DIFaddFL{with }\textbf{\DIFaddFL{10\% injection}} \DIFaddendFL of \textbf{full communication fault} to the swarm. \\	
		\hline
...
\begin{table}[!h]
	...
	\begin{tabular}{p{6mm} p{116mm}}
		...
		\hline
		4.1 & The agents in the swarm \emph{shall} travel at speeds of less than \textbf{0.5m/s} when within \textbf{2m} distance of a \textbf{trained human} \DIFaddbeginFL \DIFaddFL{(a worker who has received relevant training)}\DIFaddendFL .
		\\ 
		\hline
		...
		\\ 
		\hline
		4.4 & The swarm \emph{shall} only allow \textbf{$<$ 5 agents} to request intervention from a \textbf{trained human} at a given time\DIFaddbeginFL \DIFaddFL{.
		}\DIFaddendFL \\ 
		\hline
...
Verification Results [Z] from individual assessments form entries in the Verification Log [AA]. The Verification Log identifies assessments where assurance of the EB Algorithm [V] is acceptable with respect to the Safety Requirements [H] and can be used as a set of evidence for building an assurance case.%, eg. safety case, regulator, type approval. 
...
\DIFdelbegin \DIFdel{To this end, our future workintends }\DIFdelend \DIFaddbegin \DIFadd{In future work, we intend }\DIFaddend to build on \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{Porter2022}}\hspace{0pt}%DIFAUXCMD
, and }\DIFdelend \DIFaddbegin \DIFadd{Porter et al.’s \mbox{%DIFAUXCMD
\cite{Porter2022} }\hspace{0pt}%DIFAUXCMD
Principle-based Ethical Assurance Argument for AI and Autonomous Systems and }\DIFaddend develop ethics requirements for swarm robots around the ethical principles of beneficence, non-maleficence, respect for autonomy, and justice. 
\DIFdelbegin \DIFdel{A few examples of the core considerations to ethics requirements, each corresponding to a principle, are: (i) RQ1: The swarm }\emph{\DIFdel{shall}} %DIFAUXCMD
\DIFdel{provide benefits to stakeholders; (ii) RQ2: The swarm }\emph{\DIFdel{shall}} %DIFAUXCMD
\DIFdel{avoid causing unjustified harm to stakeholders; (iii) RQ3: The swarm }\emph{\DIFdel{shall}} %DIFAUXCMD
\DIFdel{avoid undue constraints on stakeholders' personal autonomy; and (iv) RQ4: The swarm }\emph{\DIFdel{shall}} %DIFAUXCMD
\DIFdel{allow fair treatment of stakeholders. 
}\DIFdelend %DIF > For example, based on these four principles, we may produce four key principles: (i) the swarm shall provide benefits to stakeholders; (ii) the swarm shall avoid causing unjustified harm to stakeholders; (iii) the swarm shall avoid undue constraints on stakeholders’ personal autonomy; and (iv) the swarm shall allow fair treatment of stakeholders. % Removed as informed by Pete on 3 Feb 2023
In addition to ethics requirements, we intend to introduce regulatory requirements into the consideration of AS specification. In particular, we observe the work of Macrae’s\DIFaddbegin \DIFadd{~}\DIFaddend \cite{macrae2021learning} Structural, Organisational, Technological, Epistemic, and Cultural (SOTEC) framework to help us identify sources of socio-technical risk in Autonomous and Intelligent systems. Viewing regulatory requirement analysis from a socio-technical perspective allows us to move away from a purely technical conception of requirements, and helps us design AS that better fit the organisation and operators’ work in which safety considerations are meaningful within the wider system and operational context. \DIFdelbegin \DIFdel{We will illustrate the }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend relevance of SOTEC for crafting regulatory requirements for the swarms in the cloakroom as a safety assurance mechanism \DIFdelbegin \DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{will be described in a future paper. 
}


%DIF > While the focus of the AERoS process is to ensure safety assurance of EB in swarms, the trustworthiness of an AS can be dependent on many factors other than safety, which include consideration of ethics, and governance and regulation of AS design and operation. 
%DIF > To this end, our future work intends to build on \cite{Porter2022}, and develop ethics requirements for swarm robots around the ethical principles of beneficence, non-maleficence, respect for autonomy, and justice. A few examples of the core considerations to ethics requirements, each corresponding to a principle, are: (i) RQ1: The swarm \emph{shall} provide benefits to stakeholders; (ii) RQ2: The swarm \emph{shall} avoid causing unjustified harm to stakeholders; (iii) RQ3: The swarm \emph{shall} avoid undue constraints on stakeholders' personal autonomy; and (iv) RQ4: The swarm \emph{shall} allow fair treatment of stakeholders. 
%DIF > In addition to ethics requirements, we intend to introduce regulatory requirements into the consideration of AS specification. In particular, we observe the work of Macrae’s \cite{macrae2021learning} Structural, Organisational, Technological, Epistemic, and Cultural (SOTEC) framework to help us identify sources of socio-technical risk in Autonomous and Intelligent systems. Viewing regulatory requirement analysis from a socio-technical perspective allows us to move away from a purely technical conception of requirements, and helps us design AS that better fit the organisation and operators’ work in which safety considerations are meaningful within the wider system and operational context. We will illustrate the relevance of SOTEC for crafting regulatory requirements for the swarms in the cloakroom as a safety assurance mechanism.
\DIFaddend 
