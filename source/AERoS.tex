...
Each stage of the AERoS process includes an activity to instantiate a safety argument pattern, following AMLAS~\cite{Hawkins2021}. 
...
Due to space limitations, the descriptions of an argument pattern (e.g. [F]) are not included in this paper. 
The instantiated argument [G] along with other other instantiated arguments resulting from the other five stages of AERoS constitute the safety case for the swarm. 
%The safety case for the swarm will constitute all the instantiated arguments resulting from the six stages of AERoS.%, these will constitute the safety case for the swarm. 
%Along with the other instantiated arguments resulting from the other five stages of AERoS, these will constitute the safety case for the swarm. 
