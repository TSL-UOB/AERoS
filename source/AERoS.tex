...
\begin{figure}[!t]
	...
	\begin{minipage}[b]{.5\textwidth}
		...
		%\vspace{-2ex}
		\caption{Inputs fed into individual agent behaviour producing overall swarm emerging behaviour. }%{System description.}
		\label{system-description}
      \end{minipage}%
...
\begin{figure}[t]
	...
	\begin{minipage}[b]{.5\textwidth}
		...
		\vspace{-2ex}
		\caption{Stage 2: The AERoS emerging behaviour safety requirements assurance.}% process.}
	\label{amlas-a-stage2}
  \end{minipage}%
  \hspace*{0.03\textwidth}
