...
\begin{figure}[!t]
	...
	\vspace{-4ex}
\end{figure}
% KE modified for space between figures 15/02/2023
%\begin{figure}[!t]
%	%\vspace{-4ex}
%	\centering
...
%Dhaminda Slightly increased size of Fig. 3 16/02/23
\begin{figure}[!t]
	\centering
...
%Dhaminda Slightly increased size of Fig. 5 for legibility 16/02/23
\begin{figure}[t]
	\centering
...
\begin{figure}[!t]
	...
	\begin{minipage}[b]{.47\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{figures/AERoS-Stage5-v2.png}%AMLAS-STAGE-5-V4.png
			\vspace{-2ex}
	...
	\begin{minipage}[b]{.5\textwidth}
			\centering
			\includegraphics[width=0.99\textwidth]{figures/AERoS-Stage6-v2.png}%AMLAS-STAGE-6-V5.png
			\vspace{-2ex}
