...
\begin{table}[!t]
	...
	\begin{tabular}{p{5mm} p{116mm} }
		...
		\hline
        1.5 & The swarm agents \emph{shall} weigh \textbf{$<$ 3kg} and shall have acceleration \textbf{$<$ 4m/s} in order that the maximum collision force in the swarm is within acceptable bounds. \\
        \hline
        1.6 & The swarm agents \emph{shall} only carry objects of weight less \textbf{$<$ 2kg}. \\
        \hline
