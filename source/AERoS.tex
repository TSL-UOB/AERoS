...
\begin{figure}[!t]
	...
	\begin{minipage}{.5\textwidth}
		...
		%\vspace{-2ex}
		\caption{Inputs fed into individual agents to instruct their behaviour producing a swarm level emergent behaviour. }%{System description.}
		\label{system-description}
	\end{minipage}%
	\begin{minipage}{.45\textwidth}
		\centering
...
(iv) environment: sum of objects in the area. %/$m^2$.
...
%\vspace{-2.5ex}
The authors would like to thank John Downer, Jonathan Ives, Alvin Wilby, and the rest of the AMLAS team for their fruitful comments. The work presented in this paper has been supported by the UK Engineering and Physical Sciences Research Council (EPSRC) under the grant [EP/V026518/1].
