...
%The cloakroom is automated by deploying a swarm of robots to assist attendees...
...
\begin{figure*}[!b]
	\centering
	\vspace{-3ex}
	\includegraphics[width=1.0\textwidth]{figures/AERoS-Process-v2.png}%AMLAS-STAGE-3-V4.png
	\vspace{-3ex}
...
\begin{figure*}[!b]%[!ht]
	\centering
	\vspace{-5ex} % -
	\includegraphics[width=0.71\textwidth]{figures/AERoS-Stage3.png}%width=0.75
	\vspace{-2ex} % 2
...
An example of a test case could include a scenario of the swarm in a hazardous environment (too many boxes creating an obstacle).%, so it adapts in a safe way.%, thus ensuring that it is able to adapt in a safe way. % (too many boxes, creating an obstacle). 
