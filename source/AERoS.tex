...
\begin{figure*}[!b]
	\centering
	\vspace{-3ex}
	\includegraphics[width=0.87\textwidth]{figures/AERoS-Process-v2.png}%AMLAS-STAGE-3-V4.png
	\vspace{-3ex}
...
\begin{figure*}[!b]%[!ht]
	\centering
	\vspace{-5ex} % -
	\includegraphics[width=0.72\textwidth]{figures/AERoS-Stage3.png}%width=0.75
	\vspace{-2ex} % 2
