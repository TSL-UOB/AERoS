...
In this paper, we explore it using an case study centered on a robot swarm operating a public cloakroom. 
The robot swarm uses distributed situational awareness to assist attendees (customers) to deposit, store, and deliver their belongings (e.g. jackets) \cite{Jones2020}. As the swarm operates in a public setting, the system must prioritise public safety. 
%Pop-up cloakroom powered by a swarm of robots using distributed situational awareness
...
Then, IEEE through its Global Initiative on Ethics of Autonomous and Intelligent Systems initiated the development of a series of standards to address autonomy, ethical issues, transparency, data privacy and trustworthiness (e.g. IEEE P7001, P7007, P7010).  %~\cite{IEEE-P7001}
...
\begin{figure*}[!b]
	\centering
		\vspace{-5ex}
	\includegraphics[width=0.8\textwidth]{figures/AERoS-Process.png}%AMLAS-STAGE-3-V4.png
	\vspace{-2ex}
	\caption{The AERoS process}%: iterative-by-design and the six stages where assurance activities are performed in parallel to development. 
	\label{aeros-process}
	\vspace{-4ex}
\end{figure*}
	%\vspace{-4ex}
